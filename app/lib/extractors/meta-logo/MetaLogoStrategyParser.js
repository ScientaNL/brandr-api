class MetaLogoStrategyParser extends AbstractMetaExtractorParser {
	...
	getQueries() {
		return [
			...
			{
				type: 'meta/property=og:image:url',
				query: 'meta[property="og:image:url"]',
				weight: .4,
				extractor: 'meta',
			},
			{
			...
			},
			{
				...
				query: 'meta[content="logo"]',
				weight: 1,
				extractor: 'meta',
			},
			{
				type: 'meta/content=image',
				query: 'meta[content="image"]',
				weight: .75,
				extractor: 'meta',
			},
			{
				type: 'meta/itemprop=logo',
				query: 'meta[itemprop="logo"]',
				weight: 1,
				extractor: 'meta',
			},
			{
				type: 'meta/itemprop=image',
			...
			{
				type: 'link/rel=fluid-icon',
				query: 'link[rel="fluid-icon"]',
				weight: .75,
				extractor: 'link',
			},
			{
				type: 'link/rel=apple-touch-icon',
	...
	getRefiners() {
		return [
			{
				name: 'containsWordLogo',
				regex: /logo/i,
				force: 2,
			},
			{
				name: 'containsWordBrand',
				regex: /brand/i,
				force: 1.5,
			},
			{
				name: 'containsWordRetina',
				regex: /retina/i,
				force: 1.5,
			},
			{
				name: 'containsLogoDimensions',
				regex: /([0-4][0-9][0-9]|500)x([0-4][0-9][0-9]|500)/i,
				force: 1.5,
			},
			{
				name: 'isFavicon',
